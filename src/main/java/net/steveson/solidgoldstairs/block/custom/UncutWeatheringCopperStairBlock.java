...
public class UncutWeatheringCopperStairBlock extends StairsBlock implements Oxidizable, SteveHasWeatheringCopper {

    private final Oxidizable.OxidationLevel weatheringState;

    public UncutWeatheringCopperStairBlock(OxidationLevel weatheringState, BlockState baseBlockState, Settings settings) {
    ...
    public static Optional<Block> getNextBlock(Block block) {
        if (block == ModBlocks.COPPER_STAIRS) {
            return Optional.of(ModBlocks.EXPOSED_COPPER_STAIRS);
        } else if (block == ModBlocks.EXPOSED_COPPER_STAIRS) {
            return Optional.of(ModBlocks.WEATHERED_COPPER_STAIRS);
        } else if (block == ModBlocks.WEATHERED_COPPER_STAIRS) {
    ...
    public static Optional<Block> getPreviousBlock(Block block) {
        if (block == ModBlocks.EXPOSED_COPPER_STAIRS) {
            return Optional.of(ModBlocks.COPPER_STAIRS);
        } else if (block == ModBlocks.WEATHERED_COPPER_STAIRS) {
            return Optional.of(ModBlocks.EXPOSED_COPPER_STAIRS);
        } else if (block == ModBlocks.OXIDIZED_COPPER_STAIRS) {
            return Optional.of(ModBlocks.WEATHERED_COPPER_STAIRS);
        }
        return Optional.empty();
    }
    ...
    public static Optional<Block> getWaxedBlock(Block block) {
        if (block == ModBlocks.COPPER_STAIRS) {
            return Optional.of(ModBlocks.WAXED_COPPER_STAIRS);
        } else if (block == ModBlocks.EXPOSED_COPPER_STAIRS) {
            return Optional.of(ModBlocks.WAXED_EXPOSED_COPPER_STAIRS);
        } else if (block == ModBlocks.WEATHERED_COPPER_STAIRS) {
            return Optional.of(ModBlocks.WAXED_WEATHERED_COPPER_STAIRS);
        } else if (block == ModBlocks.OXIDIZED_COPPER_STAIRS) {
            return Optional.of(ModBlocks.WAXED_OXIDIZED_COPPER_STAIRS);
        }
        return Optional.empty();
    }
    ...
    public void randomTick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
        WeatheringHelper.tryWeather(state, world, pos, random, UncutWeatheringCopperStairBlock::getNextBlock);
    }
